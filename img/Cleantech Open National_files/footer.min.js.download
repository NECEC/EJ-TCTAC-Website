...
var mmm_ux_1=function(){$("body").on("click",".js-arrow-mobile",(function(){if(sub_target=$(this).next(),n_sub_items=sub_target.children().length,h=$(this).parent().outerHeight(),$(this).hasClass("is-active"))new transition({element:sub_target[0],prop:"height",style:"height 0.4s ease-in-out",val:"0"}),$(this).removeClass("is-active");else new transition({element:sub_target[0],prop:"height",style:"height 0.4s ease-in-out",val:"auto"}),$(this).addClass("is-active")}))};mmm_ux_1();
var f1_cont=document.getElementById("sk-footer--1"),f2_cont=document.getElementById("sk-footer--2"),f1_menu=document.getElementById("footerone"),f2_menu=document.getElementById("footertwo");function cutPasteMenu(e,t){if(e&&t)t.parentNode.removeChild(t),e.appendChild(t);if(t)t.classList.add("sk-show-menu")}cutPasteMenu(f1_cont,f1_menu),cutPasteMenu(f2_cont,f2_menu);
...
var sliders_in_page={};const infoPlatform=document.getElementById("platform_info");let namePlatform=false;if(null!=infoPlatform)namePlatform=infoPlatform.getAttribute("data-platform-name");const isSnam="Snam Open Innovation"===namePlatform;function initSwiper(){sliders_in_page={};var e=document.getElementsByClassName("swiper-container"),i=0;if(0!=e.length)for(var t=0,s=e.length;t<s;t++){if(e[t].classList.contains("vue-swiper"))return;var n=e[t],r="swiper_-_"+(i+t);n.setAttribute("id",r),n.parentElement.setAttribute("id","parent-_-"+r);var a=(n=document.getElementById(r)).getAttribute("data-loop")??false,l=n.getAttribute("data-autoplay");if(!isNaN(l)&&null!=l)l={delay:l,disableOnInteraction:true};else l="";var p,o=n.getAttribute("data-breackpoints");if(o&&null!=o){const[e,i]=format(o);if(breakpoints=i,e)p=e}else p=isSnam?1:4,breakpoints={420:{slidesPerView:1},640:{slidesPerView:2},768:{slidesPerView:3},1024:{slidesPerView:3,noSwiping:false}};switch(n.getAttribute("data-type")){case"single-slide":sliders_in_page[t]=new Swiper(n,{noSwipingClass:"swiper-slide",loop:a,autoplay:l,pagination:{el:"#parent-_-"+r+" .swiper-pagination",clickable:false},navigation:{nextEl:"#parent-_-"+r+" .swiper-button-next",prevEl:"#parent-_-"+r+" .swiper-button-prev"},slidesPerView:1,on:{init(){if(this.el.classList.add("swiper-no-btn"),this.slides.length<=1)this.el.classList.add("swiper-no-swiping")}}});break;default:sliders_in_page[t]=new Swiper(n,{notNextTick:true,grabCursor:true,slidesPerView:p,speed:800,spaceBetween:20,observer:true,observeParents:true,watchOverflow:true,loop:a,autoplay:l,pagination:{el:"#parent-_-"+r+" .swiper-pagination",clickable:true,dynamicBullets:false,renderBullet:(e,i)=>`\n                                    <span class="${i} swiper-pagination-bullet-custom">\n                                        ${e+1}\n                                    </span>\n                                `},navigation:{nextEl:"#parent-_-"+r+" .swiper-button-next",prevEl:"#parent-_-"+r+" .swiper-button-prev"},breakpoints:breakpoints,on:{init(){if(this.slides.length<=1)this.el.classList.add("swiper-no-swiping");if(this.slides.length<p)this.el.classList.add("swiper-no-btn");setTimeout(()=>updateSwiperWrapperRightMargin(this),900)},slideChange(){setTimeout(()=>updateSwiperWrapperRightMargin(this),900)},resize(){updateSwiperWrapperRightMargin(this)}}})}i++}}function updateSwiper(){for(var e=0,i=Object.keys(sliders_in_page).length;e<i;e++)sliders_in_page[e].update()}function format(e){const i={};let t=0;return e.split(";").forEach(e=>{const[s,n]=e.split(":");if("default"!==s){if(Number(s)!==NaN&&0!==Number(s))i[Number(s)]={slidesPerView:Number(n)}}else t=Number(n)}),[t,i]}window.updateSwiperWrapperRightMargin=e=>{if(!isSnam)return;if(!e.slides||!e.slides.length)return;const i=e.slides[e.slides.length-1].classList.contains("swiper-slide--hidden");if(e.isEnd&&i)return;if(i)e.removeSlide(e.slides.length-1),e.update();const t=e.slides[e.slides.length-1],s=document.body.getBoundingClientRect(),n=t.firstChild.getBoundingClientRect();if(n.right>=s.right&&n.left<s.right)e.appendSlide('\n            <div\n                class="swiper-slide swiper-slide--hidden"\n                style="visibility:hidden;opacity:0;"\n            >\n            </div>\n        '),e.update()},initSwiper();
!function(e,t){if("function"==typeof define&&define.amd)define([],(function(){return e.returnExportsGlobal=t()}));else if("object"==typeof exports)module.exports=t();else e.ResizeSensor=t()}(this,(function(){return function(){"use strict";var e=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||function(e){return window.setTimeout(e,20)};function t(){var e,t;this.q=[],this.add=function(e){this.q.push(e)},this.call=function(){for(e=0,t=this.q.length;e<t;e++)this.q[e].call()}}function i(i,n){if(!i.resizedAttached)i.resizedAttached=new t,i.resizedAttached.add(n);else if(i.resizedAttached)return void i.resizedAttached.add(n);i.resizeSensor=document.createElement("div"),i.resizeSensor.className="resize-sensor";var s="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden; opacity: 0;",o="position: absolute; left: 0; top: 0; transition: 0s;";if(i.resizeSensor.style.cssText=s,i.resizeSensor.innerHTML='<div class="resize-sensor-expand" style="'+s+'"><div style="'+o+'"></div></div><div class="resize-sensor-shrink" style="'+s+'"><div style="'+o+' width: 200%; height: 200%"></div></div>',i.appendChild(i.resizeSensor),"static"==function(e,t){if(e.currentStyle)return e.currentStyle[t];else if(window.getComputedStyle)return window.getComputedStyle(e,null).getPropertyValue(t);else return e.style[t]}(i,"position"))i.style.position="relative";var r=i.resizeSensor.childNodes[0],d=r.childNodes[0],l=i.resizeSensor.childNodes[1],c=function(){d.style.width="100000px",d.style.height="100000px",r.scrollLeft=1e5,r.scrollTop=1e5,l.scrollLeft=1e5,l.scrollTop=1e5};c();var a,f,u,h,p=false,v=function(){if(i.resizedAttached){if(p)i.resizedAttached.call(),p=false;e(v)}};e(v);var y=function(){if((u=i.offsetWidth)!=a||(h=i.offsetHeight)!=f)p=true,a=u,f=h;c()},z=function(e,t,i){if(e.attachEvent)e.attachEvent("on"+t,i);else e.addEventListener(t,i)};z(r,"scroll",y),z(l,"scroll",y)}var n=function(e,t){var n=Object.prototype.toString.call(e),s=this._isCollectionTyped="[object Array]"===n||"[object NodeList]"===n||"[object HTMLCollection]"===n||"undefined"!=typeof jQuery&&e instanceof window.jQuery||"undefined"!=typeof Elements&&e instanceof window.Elements;if(this._element=e,s)for(var o=0,r=e.length;o<r;o++)i(e[o],t);else i(e,t)};return n.prototype.detach=function(){var e=this._isCollectionTyped,t=this._element;if(e)for(var i=0,s=t.length;i<s;i++)n.detach(t[i]);else n.detach(t)},n.detach=function(e){if(e.resizeSensor)e.removeChild(e.resizeSensor),delete e.resizeSensor,delete e.resizedAttached},n}()}));
...
function Collapsible(e,t){if(this.container=this.queryContainer(e),this.threshold=t,isNaN(t)){if(this.offsetEl=document.querySelector(t),!this.offsetEl)return;this.threshold=this.offsetEl.offsetWidth+15}else this.threshold=t;this.items=this.container.querySelectorAll("li"),this.itemsDimensions=this.getItemsDimensions()}Collapsible.prototype.queryContainer=function(e){var t=document.querySelector(e);if(!t)throw new Error('Collapsible: No element find using "'+e+'" selector');return t},Collapsible.prototype.getItemsDimensions=function(){for(var e=[],t=0;t<this.items.length;t++){var s=this.items[t].getBoundingClientRect().width;e.push(s)}return e},Collapsible.prototype.getAmountOfItemsToCollapse=function(){for(var e={amount:0,width:0},t=document.body.offsetWidth,s=0;s<this.items.length;s++){var i=this.itemsDimensions[s];if(e.width+=i,t-e.width<this.threshold)break;e.amount++}return this.items.length-e.amount},Collapsible.prototype.collapse=function(){var e=this.container.querySelector(".collapsible-menu"),t=e.querySelector(".collapsible-dropdown").querySelectorAll("li"),s=this.getAmountOfItemsToCollapse();if(e.classList.remove("hide"),0===s)e.classList.add("hide");for(var i=0;i<this.items.length;i++){var o=this.items[i],l=t[i];o.classList.remove("hide"),l.classList.add("hide")}for(i=0;i<s;i++){var n=t.length-i-1;o=this.items[n],l=t[n];o.classList.add("hide"),l.classList.remove("hide")}},Collapsible.prototype.inject=function(e){var t=document.createElement("li");t.classList.add("collapsible-menu","dropdown");var s=document.createElement("span");s.classList.add("icon-more");var i=document.createElement("ul");i.classList.add("collapsible-dropdown","dropdown-menu");var o=document.createElement("a");o.setAttribute("data-toggle","dropdown"),o.setAttribute("href","#"),o.setAttribute("title","Show more"),o.classList.add("dropdown-toggle","collapsible-toggle");var l=document.createElement("span");l.setAttribute("class","selected-tab hide"),l.innerHTML=e;for(var n=0;n<this.items.length;n++){var r=this.items[n].cloneNode(true);r.classList.add("hide"),i.append(r)}o.append(l),o.append(s),t.append(o),t.append(i),this.container.append(t)},Collapsible.prototype.render=function(){var e=this.container.getAttribute("data-selected-tab");if(!e)e="";this.inject(e),this.collapse(),new ResizeSensor(this.container.parentElement,this.collapse.bind(this))};
...
function initBreaks(e){if(e)if(!e.classList.contains("sk-default-profile-tabs")){if(e.classList.contains("sk-default-profile-anchors"))return void profileAnchors()}else profileTabs()}function profileTabs(){var e=document.querySelectorAll("body.skentryViewentryView .is-breakpoint"),t=document.querySelectorAll("body.skentryViewentryView .is-tab-breakpoint"),a=document.querySelector("body");if(addClass(e[0],"active"),t.length&&t[0].parentElement){addClass(t[0].parentElement,"active"),t[0].parentElement.setAttribute("data-is-active","true"),console.log(t[0].parentElement),document.querySelector(".item-breakpoint-navigation #navbar-first .navbar-nav").setAttribute("data-selected-tab",t[0].textContent)}a.addEventListener("click",(function(a){var r=a.target;if(hasClass(r,"is-tab-breakpoint")){setTabName(r),a.preventDefault();for(var n=document.querySelector(r.getAttribute("href")),i=0;i<e.length;++i)removeClass(e[i],"active"),removeClass(t[i],"active"),removeClass(t[i].parentElement,"active"),t[i].parentElement.setAttribute("data-is-active","false");addClass(n,"active"),addClass(r.parentElement,"active"),r.parentElement.setAttribute("data-is-active","true")}}))}function profileAnchors(){var e=document.querySelectorAll("body.skentryViewentryView .is-breakpoint"),t=document.querySelectorAll("body.skentryViewentryView .is-tab-breakpoint"),a=document.querySelector("body");if(addClass(e[0],"active"),t.length&&t[0].parentElement)addClass(t[0].parentElement,"active");a.addEventListener("click",(function(a){var r=a.target;if(hasClass(r,"is-tab-breakpoint")){a.preventDefault();for(var n=document.querySelector(r.getAttribute("href")),i=0;i<e.length;++i)removeClass(e[i],"active"),removeClass(t[i],"active"),removeClass(t[i].parentElement,"active");addClass(n,"active"),$("html, body").animate({scrollTop:$(r.getAttribute("href")).offset().top-42},300)}}));var r=$("#navbar-first"),n=r.outerHeight()+15,i=r.find("a"),s=i.map((function(){if($(this).attr("href").indexOf("#")>-1){var e=$($(this).attr("href"));if(e.length)return e}}));$(window).scroll((function(){var e=$(this).scrollTop()+n,t=s.map((function(){if($(this).offset().top<e)return this})),a=(t=t[t.length-1])&&t.length?t[0].id:"";i.parent().removeClass("active").end().filter("[href='#"+a+"']").parent().addClass("active")}))}function setTabName(e){var t=document.querySelector(".collapsible-toggle"),a=document.querySelector(".selected-tab");document.querySelector(".item-breakpoint-navigation #navbar-first .navbar-nav").setAttribute("data-selected-tab",e.textContent),a.innerHTML=e.textContent,t.prepend(a)}initBreaks(document.querySelector(".sk-default-theme-profile,.sk-user-theme-profile,.sk-snapshot-theme-profile"));
document.addEventListener("DOMContentLoaded",(function(){var t=window.location.hash.substr(1);if(t){if(0!=document.querySelectorAll('.nav-tabs a[href="#'+t+'"]').length)$('.nav-tabs a[href="#'+t+'"]').tab("show")}}));
var vidbg=function(e){var t={};function n(r){if(t[r])return t[r].exports;var o=t[r]={i:r,l:!1,exports:{}};return e[r].call(o.exports,o,o.exports,n),o.l=!0,o.exports}return n.m=e,n.c=t,n.d=function(e,t,r){n.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:r})},n.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},n.t=function(e,t){if(1&t&&(e=n(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var r=Object.create(null);if(n.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var o in e)n.d(r,o,function(t){return e[t]}.bind(null,o));return r},n.n=function(e){var t=e&&e.__esModule?function(){return e["default"]}:function(){return e};return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.p="",n(n.s=1)}([function(e,t,n){"use strict";var r="#?[".concat("a-f\\d","]{3}[").concat("a-f\\d","]?"),o="#?[".concat("a-f\\d","]{6}([").concat("a-f\\d","]{2})?"),i=new RegExp("[^#".concat("a-f\\d","]"),"gi"),a=new RegExp("^".concat(r,"$|^").concat(o,"$"),"i");e.exports=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("string"!=typeof e||i.test(e)||!a.test(e))throw new TypeError("Expected a valid hex string");var n=1;8===(e=e.replace(/^#/,"")).length&&(n=parseInt(e.slice(6,8),16)/255,e=e.slice(0,6)),4===e.length&&(n=parseInt(e.slice(3,4).repeat(2),16)/255,e=e.slice(0,3)),3===e.length&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]);var r=parseInt(e,16),o=r>>16,l=r>>8&255,c=255&r;return"array"===t.format?[o,l,c,n]:{red:o,green:l,blue:c,alpha:n}}},function(e,t,n){"use strict";n.r(t);var r=n(0),o=n.n(r);function i(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},r=Object.keys(n);"function"==typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(n).filter((function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable})))),r.forEach((function(t){l(e,t,n[t])}))}return e}function a(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function l(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}
/*!
 * vidbg.js v2.0.1 (https://github.com/blakewilson/vidbg)
 * vidbg.js By Blake Wilson
 * @license Licensed Under MIT (https://github.com/blakewilson/vidbg/blob/master/LICENSE)
 */var c=function(){function e(t,n,r){var a=this;if(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),l(this,"createContainer",(function(){a.containerEl=document.createElement("div"),a.containerEl.className="vidbg-container",a.containerEl.style.position="absolute",a.containerEl.style.zIndex="-1",a.createPoster(),a.el.appendChild(a.containerEl)})),l(this,"createOverlay",(function(){if(a.overlayEl=document.createElement("div"),a.overlayEl.className="vidbg-overlay",a.options.overlay){var e=function(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=[],r=!0,o=!1,i=void 0;try{for(var a,l=e[Symbol.iterator]();!(r=(a=l.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(e){o=!0,i=e}finally{try{r||null==l["return"]||l["return"]()}finally{if(o)throw i}}return n}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}(o()(a.options.overlayColor,{format:"array"}),3),t=[e[0],e[1],e[2],a.options.overlayAlpha];a.overlayEl.style.backgroundColor="rgba(".concat(t.join(", "),")")}a.containerEl.appendChild(a.overlayEl)})),l(this,"createPoster",(function(){a.options.poster&&(a.containerEl.style.backgroundImage="url(".concat(a.options.poster,")"))})),l(this,"createVideo",(function(){for(var e in a.videoEl=document.createElement("video"),a.videoEl.addEventListener("playing",a.onPlayEvent),a.attributes)a.videoEl[e]=a.attributes[e];if(a.options.mp4){var t=document.createElement("source");t.src=a.options.mp4,t.type="video/mp4",a.videoEl.appendChild(t)}if(a.options.webm){var n=document.createElement("source");n.src=a.options.webm,n.type="video/webm",a.videoEl.appendChild(n)}a.containerEl.appendChild(a.videoEl);var r=a.videoEl.play();void 0!==r&&r["catch"]((function(e){console.error(e),console.error("Autoplay is not supported"),a.removeVideo()}))})),l(this,"onPlayEvent",(function(e){a.resize(),a.videoEl.style.opacity=1})),l(this,"removeVideo",(function(){a.videoEl.remove()})),l(this,"getVideo",(function(){return a.videoEl})),l(this,"destroy",(function(){a.containerEl.remove()})),l(this,"resize",(function(){var e=a.containerEl.offsetWidth,t=a.containerEl.offsetHeight;e/a.videoEl.videoWidth>t/a.videoEl.videoHeight?(a.videoEl.style.width="".concat(e,"px"),a.videoEl.style.height="auto"):(a.videoEl.style.width="100%",a.videoEl.style.height="".concat(t,"px"))})),!t)return console.error("Please provide a selector"),!1;if(this.el=document.querySelector(t),!this.el)return console.error('The selector you specified, "'.concat(t,'", does not exist!')),!1;if(this.options=i({},{mp4:null,webm:null,poster:null,overlay:!1,overlayColor:"#000",overlayAlpha:.3},n),this.attributes=i({},{controls:!1,loop:!0,muted:!0,playsInline:!0},r),!this.options.mp4&&!this.options.webm)return console.error("Please provide an mp4, webm, or both."),!1;else this.init()}var t,n;return t=e,(n=[{key:"init",value:function(){this.el.style.position="relative",this.el.style.zIndex=1,this.createContainer(),this.createVideo(),this.createOverlay(),window.addEventListener("resize",this.resize)}}])&&a(t.prototype,n),e}();t["default"]=c}])["default"];
...
function animateValueUp(e,n,r,t){var a=r-n,o=n;if(r>n){var i,u=1,c=r.toString().length;for(i=0;i<c-3;i++)u*=11;var l=Math.abs(Math.floor(t/a)),s=e,m=setInterval((function(){if(o+=u,s.innerHTML=o,o>=r)s.innerHTML=r,clearInterval(m)}),l)}}function wrapNumbers(e){var n=document.querySelectorAll(e);Array.prototype.forEach.call(n,(function(e){var n=e.textContent.trim().replace(/\d+/g,(function(e){return"<span class='js-animate-number' >"+e+"</span>"}));e.innerHTML=n}))}function numberAnimation(e){var n=document.querySelectorAll(e);Array.prototype.forEach.call(n,(function(e){animateValueUp(e,0,parseFloat(e.textContent),2e3)}))}wrapNumbers(".js-an"),Array.prototype.forEach.call(document.querySelectorAll(".js-an"),(function(e){e.setAttribute("data-scroll","enabled"),e.setAttribute("data-scroll-showCallback","customFunction('Visible')")}));var scope={},trigger=new ScrollTrigger({toggle:{visible:"runNumbers",hidden:"hideNumbers"},once:true},document.body,window);trigger.callScope=scope,numberAnimation(".runNumbers .js-animate-number"),scope.customFunction=function(e){numberAnimation(".runNumbers .js-animate-number")};
...
if(document.querySelector(".skentryViewentryView")){if(document.querySelector(".sk-default-theme-profile")||window.innerWidth<769)var collapsible=new Collapsible(".item-breakpoint-navigation #navbar-first .navbar-nav","#anchor .navbar-right");else collapsible=new Collapsible(".item-breakpoint-navigation #navbar-first .navbar-nav",75);collapsible.render()}